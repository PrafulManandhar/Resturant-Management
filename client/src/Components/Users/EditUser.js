...
import EditFormRegister from "../../Validation/editFormValidation";
...
class EditUser extends Component {
  ...
  componentDidMount = async () => {
    ...
    await axios
      .get("http://localhost:5000/api/utility/add")
      .then(res => {
        this.setState({
          ...this.state,
          loading: false,
  ...
  update = e => {
    ...
    if (isValid) {
      axios
        .put(`http://localhost:5000/api/users/${this.props.match.params.id}`, this.state)
        .then(res => {
