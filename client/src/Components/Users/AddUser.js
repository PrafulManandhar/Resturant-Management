...
import FormValidationRegister from "../../Validation/FormValidationRegister";
...
class AddUser extends Component {
  ...
  componentDidMount = async () => {
    ...
    await axios.get("http://localhost:5000/api/utility/add")
      .then(res => {
        this.setState({
          loading: false,
  ...
  register = async e => {
    ...
    if (isValid) {
      ...
      await axios
        ...
        .then(res => {
          if (res.data.type === "success") {
            ...
            this.setState({ errors: res.data.errors });//Server side validation error
          } else {
            this.setState({
              message: res.data.message,
              alertVariant: "danger"
      ...
      this.setState({ errors: errors });//client side validation error
    }
  };
  showAlerts = () => {
